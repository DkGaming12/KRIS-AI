    ...
    <div className="fade-in" style={{ paddingBottom: '2rem' }}>
      ...
      <div className="section-block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          <div className="premium-card-v2 stat-card">
            ...
            <div>
              <p className="stat-label">Total Novel</p>
              <h3 className="stat-value">{stats.totalNovels}</h3>
            </div>
          </div>
          <div className="premium-card-v2 stat-card">
            ...
            <div>
              <p className="stat-label">Kata Ter-Generate</p>
              <h3 className="stat-value">{stats.totalWords.toLocaleString()}</h3>
            </div>
          </div>
          <div className="premium-card-v2 stat-card">
            ...
            <div>
              <p className="stat-label">Aktivitas Terakhir</p>
              <h3 className="stat-value" style={{ fontSize: '1.2rem', paddingTop: '4px' }}>{stats.lastActive}</h3>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="section-block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          {/* 1. Novel Generator */}
          <button
            className="premium-card-v2 feature-card"
            onClick={() => setCurrentView('generator')}
            style={{ border: '1px solid rgba(99,102,241,0.3)', background: 'linear-gradient(145deg, rgba(99,102,241,0.08), rgba(30,41,59,0.5))' }}
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
              ...
              <h3 className="feature-card-title">Novel Generator</h3>
            </div>
          ...
          <button
            ...
            style={{ border: '1px solid rgba(16,185,129,0.3)', background: 'linear-gradient(145deg, rgba(16,185,129,0.08), rgba(30,41,59,0.5))' }}
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
              ...
              <h3 className="feature-card-title">Chat & Coding Assistant</h3>
            </div>
            <p className="feature-card-desc">
          ...
          <button
            ...
            style={{ border: '1px solid rgba(245,158,11,0.3)', background: 'linear-gradient(145deg, rgba(245,158,11,0.08), rgba(30,41,59,0.5))' }}
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
              ...
              <h3 className="feature-card-title">Buat Makalah Akademik</h3>
            </div>
            <p className="feature-card-desc">
          ...
          <button
            ...
            style={{ border: '1px solid rgba(139,92,246,0.3)', background: 'linear-gradient(145deg, rgba(139,92,246,0.08), rgba(30,41,59,0.5))' }}
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
              ...
              <h3 className="feature-card-title">Ghostwriter</h3>
            </div>
            <p className="feature-card-desc">
